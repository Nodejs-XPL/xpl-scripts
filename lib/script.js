...
class Script extends EventEmitter {
	...
	sendXplMessage(command, body, bodyName, target, callback) {
		return this._scriptHost.sendXplCommand(this, command, body, bodyName, target, callback);
	}
	...
	sendXplCmnd(body, bodyName, target, callback) {
		return this._scriptHost.sendXplCommand(this, "xpl-cmnd", body, bodyName, target, callback);
	}
	...
	sendXplStat(body, bodyName, target, callback) {
		return this._scriptHost.sendXplCommand(this, "xpl-stat", body, bodyName, target, callback);
	}
	...
	sendXplTrig(body, bodyName, target, callback) {
		return this._scriptHost.sendXplCommand(this, "xpl-trig", body, bodyName, target, callback);
	}
